  ...
  return (
    <>
      <div className="py-20 pb-26 px-[10%] flex gap-10 bg-[url('/src/assets/images/background/bg-bottom-portfolio-content.png')] bg-right bg-no-repeat overflow-hidden relative">
        <img
          src="/src/assets/images/background/image-holder.png"
          alt=""
          className="absolute top-0 left-0"
        />
        <div className="w-1/2 relative group">
          <img
            src="/src/assets/images/About/222-1-500x500.jpg"
            alt=""
        ...
        <div className="w-1/2">
          ...
          <div className="grid grid-cols-2 font-bold text-xl pt-5 gap-x-5 gap-y-3">
            <p className="flex items-center gap-2">
              <img
                src="/src/assets/images/icon/right.png"
                alt=""
                className="size-[24px]"
              />
              Our Work Growth
          ...
          <div className="my-10 p-8 rounded-md shadow-md bg-white flex items-center gap-5 group">
            <img
              src="/src/assets/images/icon/icon-fcb_03.png"
              alt=""
