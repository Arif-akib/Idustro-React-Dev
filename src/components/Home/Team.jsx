                  ...
                  <div className="px-5 group">
                    <div className="relative">
                      ...
                      <div className="absolute top-0 left-[-10px] h-full flex flex-col gap-2 justify-center ">
                        <li className="list-none p-2 bg-white shadow-lg primary-color group-hover:primary-background group-hover:text-white duration-500">
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            width="18"
                    ...
                    <div className="relative shadow-md rounded-b-md pt-2 ">
                      ...
                      <div className="bg-black text-white absolute w-full z-10 top-0 pt-2 pb-[50px] duration-500 rounded-b-md scale-0 group-hover:scale-100">
